   ...
   var crt_ertSU_MM = new google.visualization.ChartWrapper({
      ...
      options: {   
            ...
            series: {
                ...
                2: {type: 'lines', color:'#777777', lineWidth: 3, lineDashStyle:[6,3], targetAxisIndex: 0}
                  },
            vAxes:{
                     0:{ title:'Avg. daily service units', titleTextStyle : {fontSize: 11, color: 'grey',}, minValue: 20000 ,viewWindow: {min: 20000}, format: 'short'},
                     1:{ title:'cum. change vs prev. year (%)',titleTextStyle : {color: '#376092', fontSize: 11}, textStyle:{color:'#376092'}}
                  },
