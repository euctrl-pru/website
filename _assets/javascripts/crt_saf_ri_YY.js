(function() {
   function dv(){
      ...
      var crt_saf_ri_YY = new google.visualization.ChartWrapper({
         ...
         options: {
            title: 'Runway Incursions (RIs)', titleTextStyle : {color: 'grey', fontSize: 12},
            ...
            vAxes:{
               ...
               1:{ title:'total nr. of reported RIs', titleTextStyle : {color: 'grey', fontSize: 11}, textStyle:{color:'grey'}}
                  },
