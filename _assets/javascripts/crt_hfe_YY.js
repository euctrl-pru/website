   ...
   var crt_hfe_YY = new google.visualization.ChartWrapper({
         ...
         dataSourceUrl: 'https://docs.google.com/spreadsheets/d/1KgOIBF93axvXD6ENQYvEsWHqnA8eW_RvGV4EQlGava4/edit?usp=sharing&sheet=HFE_YY&range=A1:C9',     
            options:{  
                  ...
                  title: 'Horiz. en-route flight eff. (yearly)', titleTextStyle : {color: 'grey', fontSize: 11},
                  ...
                  vAxis: {title: 'inefficiency (%)', titleTextStyle: {color: 'grey', fontSize: 10}, minValue: 0.0, maxValue: 0.06, viewWindow: {max: 0.06}, format: '0.0%'},
