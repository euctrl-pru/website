...
var crt_hfe_MM = new google.visualization.ChartWrapper({
      ...
      options:{   
               ...
               title: 'Horiz. en-route flight eff. (monthly)', titleTextStyle : {color: 'grey', fontSize: 11},
               legend: {position:'right', textStyle:{color: 'grey', fontSize: 10}},
               series: {
                     0: {type: 'lines', color:'#5D7CBA', lineWidth: 1},
                     1: {type: 'lines', color:'#C0504D', lineWidth: 1},
                     2: {type: 'lines', color:'#5D7CBA', lineWidth: 2, lineDashStyle:[6,3]},
                     3: {type: 'lines', color:'#C0504D', lineWidth: 2, lineDashStyle:[6,3]}            
                  },    
               vAxis: {title: 'inefficiency (%)', titleTextStyle: {color: 'grey', fontSize: 10}, minValue: 0.0, maxValue: 0.06, viewWindow: {min: 0.02, max: 0.05}, format: '0.0%'},
