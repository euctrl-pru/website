...
// CAPACITY - En-route ATFM delay - MM - CHART
   var crt_cap_ert_MM = new google.visualization.ChartWrapper({
         ...
         dataSourceUrl: 'https://docs.google.com/spreadsheets/d/1g_EclskD6qP8b_aYYhW3xrng616ZysYW5WVtGD9pOXk/edit?usp=sharing&alt=json&sheet=ERT_ATFM_MM&range=A1:L25&tq=where%20A%3D2015&headers=1',
         options: {       
                  chartArea: {left: 50, top: 20, width:'55%',height:'60%'},
                  title: 'En-route ATFM delays (monthly)',titleTextStyle : {color: 'grey', fontSize: 12},
                  ...
                  vAxis: {title:'minutes per flight',titleTextStyle : {color: 'grey', fontSize: 12}, textStyle:{color: 'grey'}},
         ...
         view: {columns: [1,4,5,6,7,8,9,10,11] }
      });
      crt_cap_ert_MM.draw();
   }
