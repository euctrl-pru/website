(function() {
   function dv(){
      ...
      var crt_saf_aso_YY = new google.visualization.ChartWrapper({
         ...
         options: {            
               title: 'ATM Specific Occurrences (ATM-S)', titleTextStyle : {color: 'grey', fontSize: 12},
               chartArea: {left: 50, top: 50, width:'70%',height:'55%'},
               legend: {position: 'right', maxLines: 3, textStyle:{color: 'grey', fontSize: 10}},
               isStacked : 'true',
               series: {
               ...
               vAxis:{title:'Number of occurrences', titleTextStyle : {color: 'grey', fontSize: 11}, textStyle:{color: 'grey'}},
