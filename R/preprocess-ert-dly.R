# prepare summaries per year and per month
...
# identify the relevant CSV files
ftype <- "ansp"
# ftype <- "fir"
csvs <- dir(
...
csvs <- dir_ls("static/download/csv/", type = "file", regexp = "ert_dly_ansp_\\d{4}\\.csv\\.bz2")
