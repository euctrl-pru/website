(function() {
   function dv(){
      ...
      var crt_cap_apt_MM = new google.visualization.ChartWrapper({
         ...
         dataSourceUrl: 'https://docs.google.com/spreadsheets/d/1gYIeqeWdcxd7mdXImchbppdI7QvZzp7ucfZdNJbBbyE/edit?usp=sharing&alt=json&sheet=APT_ATFM_MM&range=A1:M61&tq=where%20A%3D1',
         options: {
