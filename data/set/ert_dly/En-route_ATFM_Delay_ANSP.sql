...
select
  ...
  from traffic t left join delay d on (
     ...
     AND d.unit_name NOT in ('NATS','NATS (Oceanic)','HungaroControl','Avinor (Continental)','Avinor (Oceanic)','NAV Portugal (Santa Maria)','UNKNOWN','MILITARY','AIRPORT','PIA','BHANSA', 'KFOR (HungaroControl)' )
     order by 1,2,3,4
