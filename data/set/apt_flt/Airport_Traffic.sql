...
from SWH_FCT.FAC_APDS_FLIGHT_IR691 
      ...
      OR (SRC_AIRPORT   IN (SELECT apt_icao FROM PRUDEV.DSH_REL_AIRPORT_COUNTRY where APT_2015_VAL =1) and AP_MVT_TIME_UTC >= '01 JAN 2015' AND AP_MVT_TIME_UTC <'01 AUG 2015'))
...
NVL (p.ttf_arr, 0) + NVL (p.ttf_dep, 0) as FLT_TOT_1 
    ...
    WHERE p.ID = u.ID AND 
          ...
          and FLT_DATE >= '01 JAN 2014' AND FLT_DATE <'01 SEP 2015'    
          ),
DATA as 
(Select 
...
WHERE  n.DATE_FLT >= '01 JAN 2014' AND n.DATE_FLT <'01 SEP 2015' and  
