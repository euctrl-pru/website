...
[Great Circle Distance](/reference/acronym/gcd/)
...
position reports or [CPR](/reference/acronym/cpr/)) submitted by ANSPs
to the EUROCONTROL Enhanced Tactical Flow Management System
([ETFMS](/reference/acronym/etfms/)).

**[KEP](/reference/acronym/kep/)** and
**[KEA](/reference/acronym/kea/)** are performance indicators measuring
...
[Horizontal en-route flight efficiency methodology](/reference/methodology/horizontal-flight-efficiency-pi/)
...
[HFE filter and csv download `r blogdown::shortcode("fltr_i")` `r blogdown::shortcode("ndwk_i")`][HFEcsv]
use [ISO 8601][iso8601] date time format, i.e. `2017-01-02T00:00:00Z`


[HFEcsv]: /data/set/hfe/horizontal_flight_efficiency/ "HFE (CSV)"
