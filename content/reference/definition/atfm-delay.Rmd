...
communicated by the [FMP](/references/acronym/fmp/), in relation to an
airport (airport delay) or sector (en-route delay) location.

See also [ATFM delay causes and codes](/references/definition/atfm-delay-codes/).
...
For more information on the the change in methodology [click here](/references/methodology/ATFM-delay-calculation).
