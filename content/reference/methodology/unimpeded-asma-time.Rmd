...
[ASMA](/reference/acronym/asma/) (Entry-time at 40 NM upstream -
$A_\text{LET}$) and the actual landing time
([$A_\text{ALDT}$](/reference/acronym/aldt/)) is denoted
[*ASMA transit time*](/references/definition/asma_transit_time/)
($A_\text{TT}$).
...
The [*unimpeded ASMA time*](/reference/definition/unimpeded_asma_time/) is the
...
[Arrival sequencing and metering area (ASMA) additional time](/reference/definition/additional_asma_time/).
...
|---------|-------------|--------|
| ASMA entry-point	| Date-time + bearing from airport reference point (long. & lat.) | Actual trajectory from [Correlated Position Report (CPR)](/reference/acronym/cpr/) provided by NM |
