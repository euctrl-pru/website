...
The reason for the regulation is indicated by the responsible Flow Management Position [FMP](/reference/acronym/fmp/).
...
* [ATFM delay](/reference/definition/atfm-delay/).
